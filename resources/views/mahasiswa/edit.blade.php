            ...
            <div class="card">
                <div class="card-body">
                    <form action="/update/{{ $mahasiswa->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="alamat_tinggal" class="form-label">Alamat</label>
                            <textarea class="form-control" id="alamat_tinggal" name="alamat_tinggal" required>{{ $mahasiswa->alamat_tinggal }}</textarea>
                        </div>
                        <div class="mb-3">
